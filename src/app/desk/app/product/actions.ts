...
export async function saveProductProfile(form:FormData) {
  ...
  const understood=service.understand({
    ...
    targetMarketSegment:value(form,"target_market_segment"), businessGoal:value(form,"business_goal"),
  ...
  const payload={
    ...
    product_name:understood.productName, product_description:understood.productDescription||null, industry:understood.industry,
    ...
    target_market_segment:understood.targetMarketSegment||null, business_goal:understood.businessGoal||null,
