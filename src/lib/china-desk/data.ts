...
export const getPartners = (organizationId: string) => list<Partner>("partners", organizationId, "id,product_id,company_name,chinese_name,partner_type,location,website,description,products,brands,market_segment,fit_score,fit_explanation,sources,next_action,verification_status,partnership_openness,factory_verification_confidence,independent_source_count,raw_source_count,contact_evidence,contact_person,contact_role,wechat,email,phone,english_ability,interest_level,status,last_contact,notes,source,ai_assessment,ai_assessment_updated_at,updated_at");
