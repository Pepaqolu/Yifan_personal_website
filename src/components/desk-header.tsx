...
export function DeskHeader() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-line bg-paper/[0.72] backdrop-blur-2xl backdrop-saturate-150">
      <div className="page-shell py-4 sm:flex sm:h-[4.5rem] sm:items-center sm:justify-between sm:py-0">
        <div className="flex items-center justify-between">
          ...
          <span className="eyebrow text-accent sm:ml-8">China Desk</span>
        </div>
